...
def main():
    ...
    # 101 201 501 1001
    procesar_poblaciones=[1000,2000,5000,7000,10000]
    ...
    for x in procesar_poblaciones:
        ...
        if myrank==MASTER:
            ...
            ruta=os.path.join(ruta_pruebas,'Arbol_2MPI{}.txt'.format(numWorkers))    
            with open(ruta, 'a') as archivo:                               
                archivo.write(str(totalTimeEnd-totalTimeStart) + ', ')
            ruta=os.path.join(ruta_pruebas,'TamDatos_A_2MPI{}.txt'.format(numWorkers))    
            with open(ruta, 'a') as archivo:                               
                archivo.write(str(x) + ', ')
