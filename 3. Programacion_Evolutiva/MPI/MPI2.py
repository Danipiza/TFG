...
class IndividuoReal:
    def __init__(self, aviones, vInd, fit):
        self.v=[]
        self.fitness=0.0
        if fit!=None: self.fitness=fit
    ...
    def ruletaReal(self, poblacion, prob_acumulada, tam_seleccionados):
        ...
        for _ in range(tam_seleccionados):
            ...
            seleccionados.append(IndividuoReal(aviones=None,
                                           vInd=poblacion[self.busquedaBinaria(rand, prob_acumulada)].v,fit=None))
        return seleccionados
    ...
    def PMX(self, selec):
        ...
        while i<n:
            ind1=IndividuoReal(aviones=None,
                               vInd=selec[i].v,fit=None)
            ind2=IndividuoReal(aviones=None,
                               vInd=selec[i+1].v,fit=None)
            if random.random()<self.p:                
                pareja1={} # {int, int}
                pareja2={} 
            ...
            ret[i]=IndividuoReal(aviones=None,
                               vInd=ind1.v,fit=None)
            ret[i+1]=IndividuoReal(aviones=None,
                               vInd=ind2.v,fit=None)
            i+=2
...
def main():
    ...
    if myrank==MASTER:
        ...
        if funcion_idx<4: tam_genes=tamGenes(precision)
    ...
    if myrank==MASTER:
        ...
        for _ in range(numWorkers):
            ...
            for x in data:
                poblacion.append(IndividuoReal(aviones=None,vInd=x.v,fit=x.fitness))
        ...
        while generaciones>0:
            ...
            for i in range(tmp-tam_elite):
                ...
                poblacion.append(IndividuoReal(aviones=None,vInd=data[i].v,fit=data[i].fitness))
        ...
        if funcion_idx<4: 
            ...
            #init_poblacion()  
            poblacion=[IndividuoReal(aviones=aviones,vInd=None,fit=None) for _ in range(tam_poblacionDiv)]  
            ...
            while generaciones>0:
                ...
                for x in data:
                    selec.append(IndividuoReal(aviones=None,vInd=x.v,fit=x.fitness))
                
                
                #cruce_poblacionReal(selec)
                ...
                # mutacion_poblacionReal(poblacion)
