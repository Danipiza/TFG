...
# EJECUTAR
# mpiexec -np 5 python SequentialSort_MPI.py

"""
Ordenacion SequentialSort paralelizado.

Este programa tiene (np-1) workers, cada worker recibe un elemento
    que envia el master para realizar el recorrido en el array, y ordenarlo haciendo
