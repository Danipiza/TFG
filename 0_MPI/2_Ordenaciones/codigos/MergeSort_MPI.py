...
# COMPILAR
# mpiexec -np 5 python MergeSort_MPI.py

"""
Ordenacion MergeSort paralelizado con potencias de dos procesos
...
def main():  	
    ...
    if myrank==MASTER: 
        a,n=leeArchivo("100000Desc","Ordenado")   
...
def potencia_lb(n) :
    """
    n: int          Numero de workers

    return => int   Potencia mas cercana
    """
