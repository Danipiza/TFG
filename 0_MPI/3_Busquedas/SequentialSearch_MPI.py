...
# EJECUTAR
# mpiexec -np 5 python SequentialSearch_MPI.py

"""
Busqueda secuencial paralizada de un elemento.

El Master divide el array entre los procesos para que realicen la busqueda.
Una vez finalizada los Workers envian al Matser la posicion, si esta en su subarray, o "-1" si no esta.
"""
