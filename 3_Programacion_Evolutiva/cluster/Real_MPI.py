...
def main():
    ...
    procesar_poblaciones=[1000,2000,5000,7000,10000,15000,20000,30000, 40000, 50000]
    #procesar_poblaciones=[100,100,100,100,100,100]


    for x in procesar_poblaciones:
        ...
        if myrank==MASTER:
            ...
            ruta=os.path.join(ruta_pruebas,'Real_2MPI{}.txt'.format(numWorkers))    
            with open(ruta, 'a') as archivo:                               
                archivo.write(str(totalTimeEnd-totalTimeStart) + ', ')
            ruta=os.path.join(ruta_pruebas,'TamDatos_R_2MPI{}.txt'.format(numWorkers))    
            with open(ruta, 'a') as archivo:                               
                archivo.write(str(x) + ', ')
