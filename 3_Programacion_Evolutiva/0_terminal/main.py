...
"""
Programa principal para los problemas de Programacion Evolutiva.

Los parametros se inicializan en el main antes de ejecutar.
"""
...
class AlgoritmoGenetico():
    ...
    def ejecutaBin(self):
        ...
        self.evaluacion_poblacionBin()
        print(len(self.poblacion[0].genes[1].v))
...
def main():
    ...
    procesar=[25,50,100,200,500,1000,2000]    
    for x in procesar:
        tam_poblacion=x
        generaciones=10
