...
# EJECUTAR
# mpiexec -np 4 python aglomMPI.py
...
def main():      
    ...
    timeStart=MPI.Wtime()
    with open("WORKER{}.txt".format(myrank), "w") as file:   
        try:
            ...
            if myrank==MASTER:  
                ...
                while(True): 
                    ...
                    # -------------------------------------------------------------------------------------        
                    salida+="Iteracion: {}\n".format(cont)
                    salida+="Workers vivos: {}\n".format(workers)
                    salida+="Clusters: {}\nCentroides: {}\n".format(clusters,clustersCentros)
                    minW=-1
                    minD=float("inf")
                    wElim=None
                    ...
                    for i in workers:
                        ...
                        if minD>data:
                            minD=data
                            minW=i
                        salida+="Recibe de W{}. min={}\n".format(i,data)
                    
                    
                    """if wElim!=None: 
                        workers.remove(wElim) 
                        numWorkers-=1"""
                    ...
                    aux=filasAsig[c2]
                    salida+="Asignacion: {}. fila a eliminar: {} worker con esa fila: {}\n".format(filasAsig,c2,aux)
                    ...
                    salida+="Clusters: {}\nCentroides: {}\nclustNew: {}\n\n".format(clusters,clustersCentros,clustNew)
                    ...
                    if data==-1:                        
                        workers.remove(aux)
                        salida+="ELIMINA Worker{}, tam vivos={}\n".format(aux,len(workers))
                        numWorkers-=1
                ...
                while(True):
                    ...
                    if data==myrank:                
                        ...
                        if tam==0:
                            ...
                            salida+="TERMINA POR tam=0\n"
                            file.write(salida)
                            exit(1) # TERMINA LA EJECUCION
                        else: 
                            comm.send(1,dest=MASTER)

                        salida+="ELIMINA FILA: {} y continua\n".format(c2)
                        ...
                        salida+="ELIMINA COLUMNA: {} y continua\n".format(c2)
