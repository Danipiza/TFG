...
# EJECUTAR
# mpiexec -np 5 python RL_MPI_1.py

"""
Programa de Aprendizaje por Refuerzo (RL) con mejoras MPI.

Programa que calculas los mejores hiperparametros para cada laberinto
"""
