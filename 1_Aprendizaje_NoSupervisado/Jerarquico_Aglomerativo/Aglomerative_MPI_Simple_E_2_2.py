...
# EJECUTAR
# mpiexec -np 4 python Aglomerative_MPI_Simple_E_2_2.py
...
En esta mejora, el proceso que actualiza la fila primero hace el trabajo solo, hasta llegar a cierto numero 
de individuos por cluster, que empieza a dividir el trabajo
...
# Mejora solo y con ayuda. Depende del tamaño de la matriz
#   Primero lo hace solo al tener que calcular muchas distancias pero con pocos individuos por cluster
#   Luego pide ayuda a los demas procesos, al tener que calcular distancias con un mayor tiempo de computo
