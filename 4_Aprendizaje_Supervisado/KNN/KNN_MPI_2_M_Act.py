...
# EJECUTAR 
# mpiexec -np 5 python KNN_MPI_2_M_Act.py

"""
Algoritmo de clustering KNN (K-Nearest Neighbors). Con la segunda mejora MPI.

SI actualiza valores
...
Distancia entre individuso: Manhattan
